  ...
  return (
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0 max-w-xl mx-auto">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-500 mt-0.5">Manage your account security and preferences</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 shadow-sm">
        <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
          <FaUser className="w-4 h-4 text-[#008A1E]" /> Account Information
        </h2>
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100">
            ...
            <span className="text-sm font-medium text-gray-900">{profile?.role || "Guide"}</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100">
      ...
      <div className="bg-red-50 rounded-xl border border-red-200 p-5 sm:p-6">
        ...
        <p className="text-sm text-red-700 mb-4">
          Once you delete your account, there is no going back. All your bookings, earnings, and profile data will be permanently removed.
        </p>
        ...
        {!showDeleteConfirm ? (
          ...
          >
            <FaTrashAlt className="w-4 h-4" /> Delete Account
          </button>
        ) : (
          <div className="space-y-3">
