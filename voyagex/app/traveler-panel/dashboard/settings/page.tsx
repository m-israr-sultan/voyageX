...
export default function TravelerSettingsPage() {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      // Call change password endpoint (you need to add this to your API)
    ...
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0 max-w-xl mx-auto">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 shadow-sm">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100">
            ...
            <span className="text-sm font-medium text-gray-900">{profile?.role || "Traveler"}</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100">
      ...
      <div className="bg-red-50 rounded-xl border border-red-200 p-5 sm:p-6">
        ...
        <p className="text-sm text-red-700 mb-4">
          Once you delete your account, there is no going back. All your bookings, reviews, and data will be permanently removed.
        </p>
