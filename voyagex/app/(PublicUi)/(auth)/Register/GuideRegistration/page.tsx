...
export default function GuideRegistrationPage() {
  ...
  const validateCNIC = (cnic: string) => {
    const re = /^[0-9]{13,15}$/;
    return re.test(cnic.replace(/\D/g, ''));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.cnic.trim()) {
      ...
      newErrors.cnic = "Invalid CNIC number";
      hasError = true;
    }
    ...
    try {
      ...
      console.log("Guide registration:", registrationData);
      router.push("/Login");
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-2 bg-gray-100 px-2 py-1.5 rounded-lg hover:bg-gray-200 transition-colors z-10"
              >
                <Image 
          ...
          <div>
            ...
            <input
              ...
              className={`w-full h-14 px-4 rounded-xl border ${
                errors.cnic ? "border-red-500" : "border-gray-400"
              } focus:outline-none focus:ring-2 focus:ring-[#008A1E]`}
              disabled={isLoading}
            />
            {errors.cnic && (
