...
export type AuditAction =
  ...
  | 'payout.webhook_verified'
  | 'payout.webhook_signature_failed'
  | 'payout.confirmed'
  | 'subscription.webhook_received'
  | 'subscription.webhook_verified'
  | 'subscription.webhook_signature_failed'
  ...
  | 'financial.payout_account.created'
  | 'financial.payout_account.updated'
  | 'financial.payout_account.verified'
  | 'financial.payout_account.rejected'
  | 'financial.payout_account.suspended'
  | 'financial.payout.created'
  | 'financial.payout.requested'
  | 'financial.payout.processing'
  | 'financial.payout.completed'
  | 'financial.payout.failed'
  | 'financial.payout.retry'
  | 'financial.ledger.created'
  | 'financial.ledger.posted'
  | 'financial.receipt.created'
  | 'financial.receipt.emailed'
  ...
  | 'financial.reconciliation.issue_resolved'
  | 'financial.statement.imported'
  | 'financial.statement.reconciled'
  | 'financial.refund.requested'
  | 'financial.refund.approved'
  | 'financial.refund.rejected'
  | 'financial.refund.initiated'
  | 'financial.refund.processed'
  | 'financial.refund.failed'
  | 'financial.settings.updated'
  | 'financial.webhook.reprocessed'
  | 'financial.dashboard.exported';
